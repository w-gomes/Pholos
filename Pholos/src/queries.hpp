...
struct Query {
  ...
  /* SELECT * from movies */
  inline static const std::string select_all_movie = "SELECT * from movies";

  /* SELECT * from tvshow */
  inline static const std::string select_all_tvshow = "SELECT * from tvshow";

  /* SELECT * from movies using stats */
  inline static const std::string select_movie_by_stats =
    "SELECT * from movies WHERE stats={}";

  /* SELECT * from tvshow using stats */
  inline static const std::string select_tvshow_by_stats =
    "SELECT * from tvshow WHERE stats={}";

  /*** CREATE TABLE QUERIES ***/

  /* CREATE TABLE tvshow */
  inline static const std::string create_table_tvshow =
  ...
  /* CREATE TABLE movies */
  inline static const std::string create_table_movie =
